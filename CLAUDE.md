...
- `gamefacts.js` — **hand-authored wiki facts**, NOT extractable: `MUTATORS`, `variantDescriptions`, `VARIANT_OPTIONS`, `WAVE_SET_OPTIONS`, plus `CHAMPION_CLANS` (24 champions × 12 clans) and `PYRE_HEARTS`. The pipeline must never write this file.
